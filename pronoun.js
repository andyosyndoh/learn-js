function pronoun(str) {
    ...
    for (var i = 0; i < arr.length; i++) {
        if (/^i$/i.test(arr[i])) {
            ...
            obj["i"]["word"].push(findNext(arr.slice(i)));
            ...
            obj["you"]["word"].push(findNext(arr.slice(i)));
            ...
            obj["he"]["word"].push(findNext(arr.slice(i)));
            ...
            obj["she"]["word"].push(findNext(arr.slice(i)));
            ...
            obj["it"]["word"].push(findNext(arr.slice(i)));
            ...
            obj["they"]["word"] === undefined
                ? (obj["they"]["word"] = [])
                : null;
            obj["they"]["word"].push(findNext(arr.slice(i)));
            ...
            obj["we"]["word"].push(findNext(arr.slice(i)));
        }
    }
    for (var key in obj) {
